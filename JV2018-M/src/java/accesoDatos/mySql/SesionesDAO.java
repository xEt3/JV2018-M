...
import accesoDatos.db4o.UsuariosDAO; // TODO Eliminar una vez esté la clase creada
import modelo.*;
	...
	private void crearTablaSesiones() {
		try {
			stSesiones.executeQuery("CREATE TABLE IF NOT EXISTS `sesiones` (" + "`id_usuario` VARCHAR(45) NOT NULL,"
					+ "`fecha` TIMESTAMP NOT NULL," + "`estado` ENUM('EN_PREPARACION', 'ACTIVA', 'CERRADA') NOT NULL,"
